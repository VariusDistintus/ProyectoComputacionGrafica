...
int main( )
{
    ...
    Model maquina1((char*)"Models/maquina1/maquina1.obj");
    GLuint texture;
    ...
    image = stbi_load("images/Pikachu.png", &textureWidth, &textureHeight, &nrChannels, 0);
